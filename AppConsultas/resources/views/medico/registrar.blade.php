        ...
        <li>
            ...
            <div class="collapsible-body">
                <div class="row botones">
                    <button type="submit" class="btn class s4 menu" onclick="antecedentesHF()">Antecedentes Heredo
                        Familiares</button>
                    <button type="submit" class="btn class s4 menu" onclick="antecedentesPNP()">Antecedentes Personales
                        no Patológicos</button>
                    <button type="button" class="btn class s4 menu" onclick="antecedentesPP()">Antescedentes Personales
                        Patológicos</button>
                    <button type="button" class="btn class s4 menu" onclick="antecedentesGO()">Antecedentes Gineco
                        Obstetricos</button>
                    <button type="button" class="btn class s4 menu" onclick="padecimientoActual()">Padecimiento
                        Actual</button>
                    <button type="button" class="btn class s4 menu" onclick="sintomasGenerales()">Sintomas
                        Generales</button>
                    <button type="button" class="btn class s4 menu" onclick="aparatosSistemas()">Aparatos y
                        Sistemas</button>
                    <button type="button" class="btn class s4 menu" onclick="diagnosticosAnteriores()">Diagnósticos
                        Anteriores</button>
                    <button type="button" class="btn class s4 menu" onclick="exploracionFisica()">Exploración
                        Física</button>
                    <button type="button" class="btn class s4 menu" onclick="exploracionGeneral()">Exploración
                        General</button>
                    <button type="button" class="btn class s4 menu" onclick="exploracionRegion()">Exploración por
                        Región</button>
                    <button type="button" class="btn class s4 menu" onclick="sistemaMusculoEs()">Sistema Musculo
                        Esqueletico</button>
                    <button type="button" class="btn class s4 menu" onclick="diagnosticoFisio()">Diagnóstico
                        Fisioterapéutico</button>
                    ...
                    <button type="button" class="btn class s4 menu" onclick="arcosMovimiento()">Arcos de
                        Movimiento</button>
                    <button type="button" class="btn class s4 menu" onclick="parNervio()">Par/Nervio</button>
                    <button type="button" class="btn class s4 menu" onclick="escalaAshworth()">Escala de
                        Ashworth</button>
                    <button type="button" class="btn class s4 menu" onclick="reflejosOsteo()">Reflejos
                        Osteotendinosos</button>
...
<div class="section container">
    ...
    <form class="" id="ficha_id" action="{{ route('store_ficha_id') }}" method="POST">
        ...
        <div class="row">
            ...
            <div class="input-field col s12 m4">
                ...
                {!! $errors->first('nombre', '<span id="error_msj" class="helper-text" data-error="wrong"
                    data-success="right">:message</span>') !!}
            </div>
            <div class="input-field col s12 m4">
                <input id="apellido_p" name="apellido_p" type="text" class="validate" required>
                <label for="apellido_p">Apellido Paterno</label>
                {!! $errors->first('apellidoP', '<span style="color:red" id="error_msj" class="helper-text"
                    data-error="wrong" data-success="right">:message</span>') !!}

            </div>
            <div class="input-field col s12 m4">
                <input id="apellido_m" type="text" class="validate" name="apellido_m" required>
                <label for="apellido_m">Apellido Materno</label>
                {!! $errors->first('apellido_m', '<span style="color:red" id="error_msj" class="helper-text"
                    data-error="wrong" data-success="right">:message</span>') !!}
            ...
            <div class="input-field col s12 m3">
                ...
                {!! $errors->first('edad', '<span style="color:red" id="error_msj" class="helper-text"
                    data-error="wrong" data-success="right">:message</span>') !!}
            </div>
            ...
            <div class="input-field col s12 m3">
                ...
                <label>Genero</label>
                {!! $errors->first('sex', '<span style="color:red" id="error_msj" class="helper-text" data-error="wrong"
                    data-success="right">:message</span>') !!}
            ...
            <div class="input-field col s12 m3">
                ...
                {!! $errors->first('nacionalidad', '<span style="color:red" id="error_msj" class="helper-text"
                    data-error="wrong" data-success="right">:message</span>') !!}
            ...
            <div class="input-field col s12 m3">
                ...
                {!! $errors->first('est_civ', '<span style="color:red" id="error_msj" class="helper-text"
                    data-error="wrong" data-success="right">:message</span>') !!}
            ...
            <div class="input-field col s12 m3">
                ...
                {!! $errors->first('ocupacion', '<span style="color:red" id="error_msj" class="helper-text"
                    data-error="wrong" data-success="right">:message</span>') !!}
            ...
            <div class="input-field col s12 m3">
                ...
                {!! $errors->first('calle', '<span style="color:red" id="error_msj" class="helper-text"
                    data-error="wrong" data-success="right">:message</span>') !!}
            ...
            <div class="input-field col s12 m3">
                ...
                {!! $errors->first('numero_int', '<span style="color:red" id="error_msj" class="helper-text"
                    data-error="wrong" data-success="right">:message</span>') !!}
            ...
            <div class="input-field col s12 m3">
                ...
                {!! $errors->first('numero_ext', '<span style="color:red" id="error_msj" class="helper-text"
                    data-error="wrong" data-success="right">:message</span>') !!}
            ...
            <div class="input-field col s12 m4">
                ...
                {!! $errors->first('colonia', '<span style="color:red" id="error_msj" class="helper-text"
                    data-error="wrong" data-success="right">:message</span>') !!}
            ...
            <div class="input-field col s12 m4">
                ...
                {!! $errors->first('ciudad', '<span style="color:red" id="error_msj" class="helper-text"
                    data-error="wrong" data-success="right">:message</span>') !!}
            ...
            <div class="input-field col s12 m4">
                ...
                {!! $errors->first('estado', '<span style="color:red" id="error_msj" class="helper-text"
                    data-error="wrong" data-success="right">:message</span>') !!}
            ...
            <div class="input-field col s12 m4">
                ...
                {!! $errors->first('celular', '<span style="color:red" id="error_msj" class="helper-text"
                    data-error="wrong" data-success="right">:message</span>') !!}
            ...
            <div class="input-field col s12 m4">
                ...
                {!! $errors->first('religion', '<span style="color:red" id="error_msj" class="helper-text"
                    data-error="wrong" data-success="right">:message</span>') !!}
            ...
            <div class="input-field col s12 m4">
                ...
                {!! $errors->first('nombre2', '<span style="color:red" id="error_msj" class="helper-text"
                    data-error="wrong" data-success="right">:message</span>') !!}
            ...
            <div class="input-field col s12 m4">
                ...
                {!! $errors->first('tel2', '<span style="color:red" id="error_msj" class="helper-text"
                    data-error="wrong" data-success="right">:message</span>') !!}
            ...
            <div class="input-field col s12">
                ...
                {!! $errors->first('motivo', '<span style="color:red" id="error_msj" class="helper-text"
                    data-error="wrong" data-success="right">:message</span>') !!}
            ...
            <button type="submit" onclick="habilitarBotones()" class="btn col s12 m4 push-m4"
                name="button">Guardar</button>
        </div>

    </form>

    <form class="" id="antecedentes_hf" action="{{ route('hcahf',[ $idpac ]) }}" method="POST">
        {{ csrf_field() }}
        <div class="row">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            ...
                            <label>
                                <input type="checkbox" name="hermanos1" value="por parte de hermanos"
                                    class="filled-in" />
                                <span>Hermanos</span>
                            </label>
                            <label>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <label>
                                <input type="checkbox" value="por parte de hermanos" name="hermanos2"
                                    class="filled-in" />
                                <span>Hermanos</span>
                            </label>
                            <label>
                        ...
                        <td>
                            <div class="input-field col s12">
                                <textarea id="ta_enf_sisnerv" name="ta_enf_sisnerv"
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <label>
                                <input type="checkbox" value="por parte de hermanos" name="hermanos3"
                                    class="filled-in" />
                                <span>Hermanos</span>
                            </label>
                            <label>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <label>
                                <input type="checkbox" value="por parte de hermanos" name="hermanos4"
                                    class="filled-in" />
                                <span>Hermanos</span>
                            </label>
                            <label>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <label>
                                <input type="checkbox" value="por parte de hermanos" name="hermanos5"
                                    class="filled-in" />
                                <span>Hermanos</span>
                            </label>
                            <label>
                        ...
                        <td>
                            <div class="input-field col s12">
                                <textarea id="ta_congenitas" name="ta_congenitas"
                                    class="materialize-textarea"></textarea>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <label>
                                <input type="checkbox" value="por parte de hermanos" name="hermanos6"
                                    class="filled-in" />
                                <span>Hermanos</span>
                            </label>
                            <label>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <label>
                                <input type="checkbox" value="por parte de hermanos" name="hermanos7"
                                    class="filled-in" />
                                <span>Hermanos</span>
                            </label>
                            <label>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <label>
                                <input type="checkbox" value="por parte de hermanos" name="hermanos8"
                                    class="filled-in" />
                                <span>Hermanos</span>
                            </label>
                            <label>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <label>
                                <input type="checkbox" value="por parte de hermanos" name="hermanos9"
                                    class="filled-in" />
                                <span>Hermanos</span>
                            </label>
                            <label>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <label>
                                <input type="checkbox" value="por parte de abuelos" name="abuelos10"
                                    class="filled-in" />
                                <span>Abuelos</span>
                            </label>
                            <label>
                                <input type="checkbox" value="por parte de hermanos" name="hermanos10"
                                    class="filled-in" />
                                <span>Hermanos</span>
                            </label>
                            <label>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <label>
                                <input type="checkbox" value="por parte de abuelos" name="abuelos11"
                                    class="filled-in" />
                                <span>Abuelos</span>
                            </label>
                            <label>
                                <input type="checkbox" value="por parte de hermanos" name="hermanos11"
                                    class="filled-in" />
                                <span>Hermanos</span>
                            </label>
                            <label>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <label>
                                <input type="checkbox" value="por parte de abuelos" name="abuelos12"
                                    class="filled-in" />
                                <span>Abuelos</span>
                            </label>
                            <label>
                                <input type="checkbox" value="por parte de hermanos" name="hermanos12"
                                    class="filled-in" />
                                <span>Hermanos</span>
                            </label>
                            <label>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <label>
                                <input type="checkbox" value="por parte de abuelos" name="abuelos13"
                                    class="filled-in" />
                                <span>Abuelos</span>
                            </label>
                            <label>
                                <input type="checkbox" value="por parte de hermanos" name="hermanos13"
                                    class="filled-in" />
                                <span>Hermanos</span>
                            </label>
                            <label>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <label>
                                <input type="checkbox" value="por parte de abuelos" name="abuelos14"
                                    class="filled-in" />
                                <span>Abuelos</span>
                            </label>
                            <label>
                                <input type="checkbox" value="por parte de hermanos" name="hermanos14"
                                    class="filled-in" />
                                <span>Hermanos</span>
                            </label>
                            <label>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <label>
                                <input type="checkbox" value="por parte de abuelos" name="abuelos15"
                                    class="filled-in" />
                                <span>Abuelos</span>
                            </label>
                            <label>
                                <input type="checkbox" value="por parte de hermanos" name="hermanos15"
                                    class="filled-in" />
                                <span>Hermanos</span>
                            </label>
                            <label>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <label>
                                <input type="checkbox" value="por parte de abuelos" name="abuelos16"
                                    class="filled-in" />
                                <span>Abuelos</span>
                            </label>
                            <label>
                                <input type="checkbox" value="por parte de hermanos" name="hermanos16"
                                    class="filled-in" />
                                <span>Hermanos</span>
                            </label>
                            <label>
                        ...
                        <td>
                            <div class="input-field col s12">
                                <textarea id="ta_trans_hemato" name="ta_trans_hemato"
                                    class="materialize-textarea"></textarea>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <label>
                                <input type="checkbox" value="por parte de abuelos" name="abuelos17"
                                    class="filled-in" />
                                <span>Abuelos</span>
                            </label>
                            <label>
                                <input type="checkbox" value="por parte de hermanos" name="hermanos17"
                                    class="filled-in" />
                                <span>Hermanos</span>
                            </label>
                            <label>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <label>
                                <input type="checkbox" value="por parte de abuelos" name="abuelos18"
                                    class="filled-in" />
                                <span>Abuelos</span>
                            </label>
                            <label>
                                <input type="checkbox" value="por parte de hermanos" name="hermanos18"
                                    class="filled-in" />
                                <span>Hermanos</span>
                            </label>
                            <label>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="input-field col s12">
                                <textarea id="ta_ap_genital" name="ta_ap_genital"
                                    class="materialize-textarea"></textarea>
            ...
            <table class="responsive-table striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <textarea id="ta_mot_ocular_com" name="ta_mot_ocular_com"
                                class="materialize-textarea"></textarea>
                    ...
                    <tr>
                        ...
                        <td>
                            <textarea id="ta_mot_ocular_ext" name="ta_mot_ocular_ext"
                                class="materialize-textarea"></textarea>
    ...
    <map name="image-map">
        <area alt="1" title="1" name="mpd-1" id="mpd-1" href=""
            coords="485,120,483,80,493,33,520,32,548,30,595,48,601,102,580,60,535,63,498,70,492,88,493,108"
            shape="poly">
        <area alt="2" title="2" name="mpd-2" id="mpd-2" href=""
            coords="483,133,507,195,548,206,586,190,601,141,590,90,581,55,497,65" shape="poly">
        ...
        <area alt="5" title="5" name="mpd-5" id="mpd-5" href=""
            coords="546,399,556,313,620,270,553,282,583,201,540,212,503,198,528,283,470,275,528,308" shape="poly">
        <area alt="6" title="6" name="mpd-6" id="mpd-6" href="" coords="462,280,395,270,348,298,335,353,343,391,390,364"
            shape="poly">
        <area alt="7" title="7" name="mpd-7" id="mpd-7" href=""
            coords="388,371,335,398,317,453,319,519,342,516,372,503,405,446,413,393" shape="poly">
        <area alt="8" title="8" name="mpd-8" id="mpd-8" href=""
            coords="322,523,307,489,280,521,220,664,255,684,294,637,325,598,365,564,373,508,347,518" shape="poly">
        <area alt="9" title="9" name="mpd-9" id="mpd-9" href=""
            coords="215,666,205,689,144,741,169,741,151,789,172,771,166,804,189,781,209,774,217,791,230,761,237,722,252,686"
            shape="poly">
        <area alt="10" title="10" name="mpd-10" id="mpd-10" href=""
            coords="621,276,656,306,689,358,744,383,746,335,731,283,676,266" shape="poly">
        <area alt="11" title="11" name="mpd-11" id="mpd-11" href=""
            coords="693,363,680,393,691,474,718,501,766,521,778,473,753,391" shape="poly">
        <area alt="12" title="12" name="mpd-12" id="mpd-12" href=""
            coords="764,518,718,504,726,556,839,677,866,654,854,619,831,564,806,513,784,479" shape="poly">
        <area alt="13" title="13" name="mpd-13" id="mpd-13" href=""
            coords="836,682,844,716,879,797,879,767,906,807,901,767,926,806,916,766,939,792,921,741,947,731,891,691,866,656"
            shape="poly">
        <area alt="14" title="14" name="mpd-14" id="mpd-14" href=""
            coords="395,369,435,401,470,408,515,403,538,391,531,355,526,320,505,296,468,283,437,298" shape="poly">
        <area alt="15" title="15" name="mpd-15" id="mpd-15" href=""
            coords="546,396,606,404,645,398,689,373,676,341,650,303,630,283,595,285,556,308" shape="poly">
        <area alt="16" title="16" name="mpd-16" id="mpd-16" href=""
            coords="413,396,410,436,423,468,427,506,423,629,493,694,468,578,462,416,435,404" shape="poly">
        <area alt="17" title="17" name="mpd-17" id="mpd-17" href=""
            coords="617,414,678,393,678,438,663,478,663,544,672,598,672,627,648,642,627,671,583,706,616,551"
            shape="poly">
        <area alt="18" title="18" name="mpd-18" id="mpd-18" href="" coords="470,416,535,404,535,463,498,478,470,471"
            shape="poly">
        <area alt="19" title="19" name="mpd-19" id="mpd-19" href="" coords="546,403,610,411,610,473,566,474,543,466"
            shape="poly">
        <area alt="20" title="20" name="mpd-20" id="mpd-20" href="" coords="468,479,540,479,540,534,468,533"
            shape="poly">
        <area alt="21" title="21" name="mpd-21" id="mpd-21" href="" coords="545,474,611,473,610,536,548,534"
            shape="poly">
        <area alt="22" title="22" name="mpd-22" id="mpd-22" href="" coords="472,543,540,538,540,598,508,589,473,579"
            shape="poly">
        <area alt="23" title="23" name="mpd-23" id="mpd-23" href="" coords="543,543,611,540,603,586,576,588,543,596"
            shape="poly">
        <area alt="24" title="24" name="mpd-24" id="mpd-24" href="" coords="478,583,498,701,516,729,540,737,536,596"
            shape="poly">
        <area alt="25" title="25" name="mpd-25" id="mpd-25" href=""
            coords="545,598,603,586,596,639,581,706,566,734,546,741" shape="poly">
        <area alt="26" title="26" name="mpd-26" id="mpd-26" href="" coords="425,637,388,769,405,764,441,714,443,651"
            shape="poly">
        <area alt="27" title="27" name="mpd-27" id="mpd-27" href=""
            coords="440,649,438,699,498,949,513,930,518,889,530,827,530,739" shape="poly">
        <area alt="28" title="28" name="mpd-28" id="mpd-28" href=""
            coords="440,713,402,771,407,839,423,892,443,947,460,966,468,901,480,861" shape="poly">
        <area alt="29" title="29" name="mpd-29" id="mpd-29" href="" coords="395,767,378,879,423,967,442,945,408,864"
            shape="poly">
        <area alt="30" title="30" name="mpd-30" id="mpd-30" href="" coords="477,872,462,965,487,989,495,942"
            shape="poly">
        <area alt="31" title="31" name="mpd-31" id="mpd-31" href="" coords="440,949,423,980,438,994,482,992"
            shape="poly">
        <area alt="32" title="32" name="mpd-32" id="mpd-32" href="" coords="407,952,397,1037,418,1020,417,975"
            shape="poly">
        <area alt="33" title="33" name="mpd-33" id="mpd-33" href="" coords="423,1010,438,1042,478,1055,490,1030,492,994"
            shape="poly">
        <area alt="34" title="34" name="mpd-34" id="mpd-34" href=""
            coords="423,1025,400,1047,397,1107,400,1178,412,1240,428,1285,433,1192,440,1150,458,1102,478,1060"
            shape="poly">
        <area alt="35" title="35" name="mpd-35" id="mpd-35" href=""
            coords="473,1072,445,1152,432,1227,433,1280,453,1220,478,1137" shape="poly">
        <area alt="36" title="36" name="mpd-36" id="mpd-36" href=""
            coords="390,1103,372,1170,385,1240,397,1320,348,1433,418,1446,443,1365,430,1313,399,1220" shape="poly">
        <area alt="37" title="37" name="mpd-37" id="mpd-37" href=""
            coords="648,649,653,702,628,787,596,954,571,880,565,814,560,751" shape="poly">
        <area alt="38" title="38" name="mpd-38" id="mpd-38" href="" coords="670,629,704,759,685,751,656,712,650,649"
            shape="poly">
        <area alt="39" title="39" name="mpd-39" id="mpd-39" href=""
            coords="650,707,615,849,636,959,650,944,675,895,688,822,685,752" shape="poly">
        <area alt="40" title="40" name="mpd-40" id="mpd-40" href="" coords="613,869,598,990,631,967" shape="poly">
        <area alt="41" title="41" name="mpd-41" id="mpd-41" href=""
            coords="688,752,708,772,711,822,711,877,698,922,683,942,670,962,653,944,686,852" shape="poly">
        <area alt="42" title="42" name="mpd-42" id="mpd-42" href=""
            coords="648,954,625,972,596,994,616,1047,648,1047,673,1017,699,1039,698,999,694,939,670,959" shape="poly">
        <area alt="43" title="43" name="mpd-43" id="mpd-43" href=""
            coords="621,1057,648,1118,670,1205,673,1300,686,1273,691,1233,694,1192,701,1113,699,1049,673,1022,651,1047"
            shape="poly">
        <area alt="44" title="44" name="mpd-44" id="mpd-44" href=""
            coords="621,1065,621,1132,646,1222,665,1288,671,1237,653,1150" shape="poly">
        <area alt="45" title="45" name="mpd-45" id="mpd-45" href=""
            coords="708,1097,724,1158,718,1243,704,1305,723,1356,754,1416,748,1433,711,1440,680,1436,670,1396,655,1366,668,1308,685,1277,693,1217"
            shape="poly">
        <area alt="46" title="46" name="mpd-46" id="mpd-46" href=""
            coords="1463,3,1416,23,1401,102,1408,125,1435,156,1463,161,1495,153,1518,123,1526,85,1526,52,1506,17"
            shape="poly">
        <area alt="47" title="47" name="mpd-47" id="mpd-47" href="" coords="1446,160,1385,221,1466,200,1463,165"
            shape="poly">
        <area alt="48" title="48" name="mpd-48" id="mpd-48" href="" coords="1466,166,1500,158,1536,220,1468,198"
            shape="poly">
        <area alt="49" title="49" name="mpd-49" id="mpd-49" href=""
            coords="1371,230,1395,265,1408,351,1463,453,1480,438,1526,353,1531,303,1551,246,1554,223,1498,211,1458,203"
            shape="poly">
        <area alt="50" title="50" name="mpd-50" id="mpd-50" href=""
            coords="1371,226,1308,233,1267,259,1253,286,1248,321,1250,348,1313,323,1318,289,1340,279,1381,246"
            shape="poly">
        <area alt="51" title="51" name="mpd-51" id="mpd-51" href=""
            coords="1307,321,1253,353,1238,389,1218,448,1230,498,1242,436,1255,424,1262,436,1255,469,1250,489,1270,494,1288,479,1302,454,1323,414,1323,363"
            shape="poly">
        <area alt="52" title="52" name="mpd-52" id="mpd-52" href=""
            coords="1217,476,1165,568,1124,693,1170,706,1205,644,1255,561,1273,501,1252,491,1260,438,1250,424,1237,479,1230,496"
            shape="poly">
        <area alt="53" title="53" name="mpd-53" id="mpd-53" href=""
            coords="1124,692,1067,762,1100,736,1074,802,1110,752,1094,816,1124,767,1120,824,1155,754,1184,786,1172,702"
            shape="poly">
        <area alt="54" title="54" name="mpd-54" id="mpd-54" href=""
            coords="1556,235,1573,221,1606,225,1644,238,1668,258,1678,295,1683,323,1683,348,1624,318,1614,286,1569,260"
            shape="poly">
        <area alt="55" title="55" name="mpd-55" id="mpd-55" href=""
            coords="1624,325,1676,345,1694,385,1714,435,1716,467,1706,492,1694,460,1683,425,1671,428,1678,451,1681,475,1676,488,1659,488,1634,460,1613,421,1613,366"
            shape="poly">
        <area alt="56" title="56" name="mpd-56" id="mpd-56" href=""
            coords="1664,496,1678,551,1711,603,1766,692,1809,677,1794,626,1774,574,1756,524,1719,471,1703,489,1693,471,1686,426,1673,423,1679,453,1679,488"
            shape="poly">
        <area alt="57" title="57" name="mpd-57" id="mpd-57" href=""
            coords="1764,691,1752,776,1779,742,1816,807,1807,751,1847,809,1829,746,1861,781,1837,731,1874,751,1846,714,1811,679"
            shape="poly">
        <area alt="58" title="58" name="mpd-58" id="mpd-58" href=""
            coords="1383,246,1320,291,1312,326,1323,360,1342,369,1367,363,1406,348,1401,286" shape="poly">
        <area alt="59" title="59" name="mpd-59" id="mpd-59" href=""
            coords="1553,246,1581,270,1616,291,1624,318,1609,358,1584,368,1551,356,1528,348,1535,281" shape="poly">
        <area alt="60" title="60" name="mpd-60" id="mpd-60" href=""
            coords="1323,370,1327,425,1347,506,1370,530,1385,563,1390,593,1400,576,1410,550,1413,508,1430,478,1460,458,1436,415,1420,386,1401,355,1360,373"
            shape="poly">
        <area alt="61" title="61" name="mpd-61" id="mpd-61" href=""
            coords="1530,355,1573,366,1613,361,1611,393,1609,431,1603,463,1588,499,1574,514,1559,536,1551,561,1544,583,1523,546,1511,484,1488,459,1470,449"
            shape="poly">
        <area alt="62" title="62" name="mpd-62" id="mpd-62" href=""
            coords="1393,591,1413,549,1423,491,1465,456,1498,473,1520,511,1525,553,1544,588,1518,601,1481,626,1471,647,1436,609"
            shape="poly">
        <area alt="63" title="63" name="mpd-63" id="mpd-63" href=""
            coords="1352,514,1371,533,1383,561,1390,593,1363,594,1348,599" shape="poly">
        <area alt="64" title="64" name="mpd-64" id="mpd-64" href=""
            coords="1584,506,1589,536,1593,599,1564,593,1546,574" shape="poly">
        <area alt="65" title="65" name="mpd-65" id="mpd-65" href=""
            coords="1390,596,1368,624,1345,674,1327,712,1322,694,1338,634,1345,601" shape="poly">
        <area alt="66" title="66" name="mpd-66" id="mpd-66" href=""
            coords="1544,591,1594,601,1618,704,1596,682,1581,637" shape="poly">
        <area alt="67" title="67" name="mpd-67" id="mpd-67" href=""
            coords="1395,599,1355,652,1328,714,1337,759,1362,782,1418,792,1455,789,1470,714,1466,647,1435,611"
            shape="poly">
        <area alt="68" title="68" name="mpd-68" id="mpd-68" href=""
            coords="1473,646,1468,722,1488,784,1543,787,1589,776,1611,734,1608,697,1583,646,1540,594,1498,612"
            shape="poly">
        <area alt="69" title="69" name="mpd-69" id="mpd-69" href=""
            coords="1323,710,1308,784,1307,855,1313,923,1307,1007,1352,970,1365,910,1371,860,1395,795,1343,772"
            shape="poly">
        <area alt="70" title="70" name="mpd-70" id="mpd-70" href=""
            coords="1398,801,1421,934,1406,1010,1378,1075,1350,1027,1348,977,1368,925,1375,857" shape="poly">
        <area alt="71" title="71" name="mpd-71" id="mpd-71" href="" coords="1398,802,1418,930,1453,855,1458,787"
            shape="poly">
        <area alt="72" title="72" name="mpd-72" id="mpd-72" href="" coords="1323,999,1345,1029,1345,977" shape="poly">
        <area alt="73" title="73" name="mpd-73" id="mpd-73" href=""
            coords="1320,1004,1300,1027,1295,1054,1283,1092,1267,1125,1262,1177,1268,1212,1310,1177,1328,1098,1345,1035"
            shape="poly">
        <area alt="74" title="74" name="mpd-74" id="mpd-74" href=""
            coords="1350,1027,1376,1069,1373,1112,1370,1173,1352,1222,1310,1177" shape="poly">
        <area alt="75" title="75" name="mpd-75" id="mpd-75" href=""
            coords="1307,1177,1263,1213,1257,1320,1255,1396,1265,1433,1278,1436,1305,1433,1315,1405,1328,1365,1308,1333,1318,1293,1350,1222"
            shape="poly">
        <area alt="76" title="76" name="mpd-76" id="mpd-76" href=""
            coords="1544,791,1485,787,1485,831,1505,899,1518,937" shape="poly">
        <area alt="77" title="77" name="mpd-77" id="mpd-77" href=""
            coords="1548,806,1521,935,1533,1002,1564,1072,1591,1024,1594,969,1579,939" shape="poly">
        <area alt="78" title="78" name="mpd-78" id="mpd-78" href=""
            coords="1546,792,1579,947,1606,989,1636,1004,1631,947,1633,872,1634,806,1619,712,1609,744,1598,771,1569,782"
            shape="poly">
        <area alt="79" title="79" name="mpd-79" id="mpd-79" href=""
            coords="1593,1025,1603,1060,1619,1092,1634,1173,1598,1218,1576,1170,1568,1074" shape="poly">
        <area alt="80" title="80" name="mpd-80" id="mpd-80" href=""
            coords="1603,997,1636,1002,1646,1059,1671,1113,1678,1165,1681,1203,1636,1178,1598,1037" shape="poly">
        <area alt="81" title="81" name="mpd-81" id="mpd-81" href=""
            coords="1598,1222,1639,1348,1621,1360,1631,1410,1656,1431,1679,1428,1689,1398,1688,1343,1686,1263,1674,1205,1638,1178"
            shape="poly">
    </map>
